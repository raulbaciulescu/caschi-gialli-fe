...
import { mockRequestsService } from '../services/mockRequests.service';
...
const ClientDashboard: React.FC = () => {
  ...
  // API hooks
  const createRequestApi = useApi(useMockData ? mockRequestsService.createServiceRequest : requestsService.createServiceRequest);
  const getUserRequestsApi = useApi(useMockData ? mockRequestsService.getUserRequests : requestsService.getUserRequests);
  const deleteRequestApi = useApi(useMockData ? mockRequestsService.deleteRequest : requestsService.deleteRequest);
