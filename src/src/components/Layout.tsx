...
import { HardHat, Home, User, MessageSquare, Settings, LogOut, Bell, Database, Wifi } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  const { user, logout, isAuthenticated, useMockData, toggleMockData } = useAuth();
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                title={useMockData ? 'Using Mock Data - Click to use Real API' : 'Using Real API - Click to use Mock Data'}
              >
                {useMockData ? <Database className="h-4 w-4" /> : <Wifi className="h-4 w-4" />}
              </button>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between py-2">
                <div className="flex items-center space-x-2 text-sm text-green-800">
                  ...
                  <span>Using Mock Data - Perfect for testing!</span>
                </div>
                <button
                  onClick={toggleMockData}
